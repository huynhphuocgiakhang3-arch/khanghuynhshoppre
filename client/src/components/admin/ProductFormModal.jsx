...
const EMPTY_VARIANT = { name: '', price: '', salePrice: '', stock: 0, deliveryFiles: [] };
...
export default function ProductFormModal({ product, onClose, onSaved }) {
  ...
  /** Upload file giao hang cho san pham KHONG co variants */
  ...
  /** Upload file giao hang rieng cho 1 variant cu the */
  const handleVariantFileUpload = async (idx, e) => {
    ...
    try {
      ...
      toast.success('Đã tải file lên cho gói.');
    } catch (error) {
      toast.error(error.response?.data?.message || 'Tải file thất bại.');
    } finally {
            ...
            <>
              ...
              <div>
                ...
                >
                  ...
                  {isUploadingFile ? 'Đang tải lên...' : 'Thêm file giao hàng'}
                </label>
              </div>
            </>
          ) : (
